# -*- coding: utf-8 -*-
{
    ...
    'description': """
POS Daily Sales Report (v19 — build non testée en production)
=================================================================

Cette version cible Odoo 19.0. Le code est identique à la version 17.0
...
instance Odoo 19 réelle. Testez en environnement de recette avant mise
en production.
